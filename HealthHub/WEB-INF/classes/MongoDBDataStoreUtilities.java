...
public class MongoDBDataStoreUtilities {
    ...
    public static String insertReview(String productname, String username, String producttype,
        String productmaker, String reviewrating,
        String retailerpin, String price,
        String userid, String age, String gender, String occupation, String zipcode, String retailercity,
        String storestate, String productonsale, String storeid, String manufacturerebate, String reviewdate, String reviewtext) {
        try {
            getConnection();
        ...
        try {
            ...
            while (cursor.hasNext()) {
                ...
                Review review = new Review(obj.getString("productName"), obj.getString("userName"), obj.getString("productType"), obj.getString("productMaker"),
                    ...
                    obj.getString("age"), obj.getString("gender"),
                    obj.getString("occupation"), obj.getString("storestate"),
                    obj.getString("productonsale"), obj.getString("storeid"),
                    obj.getString("manufacturerebate"));
    ...
    public static ArrayList < Review > selectReviewForChart() {
        ...
        try {
			...
			System.out.println("this is the arraylist"+reviewList);
            return reviewList;
