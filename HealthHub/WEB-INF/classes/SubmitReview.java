...
public class SubmitReview extends HttpServlet {
    ...
    protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String storeid = "12354";
            String manufacturerebate = "yes";
            String reviewdate = request.getParameter("reviewdate");
            String reviewtext = request.getParameter("reviewtext");

            String message = utility.storeReview(productname, producttype, productmaker, reviewrating,
                retailerpin, productprice,
                userid, age, gender, occupation, zipcode, retailercity, storestate,
                productonsale, storeid, manufacturerebate, reviewdate, reviewtext);
