...
public class Insurance extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(CategoryName==null){
			hm = MySqlDataStoreUtilities.getInsurance();
			name = "";
		}
		else
		{

			for(Map.Entry<String,Com> entry : MySqlDataStoreUtilities.getInsurance().entrySet())
			{
		...
		pw.print("<a style='font-size: 24px;'>"+(CategoryName==null ? "":CategoryName)+" Insurance</a>");
		...
		for(Map.Entry<String, Com> entry : hm.entrySet())
		{
			...
			pw.print("<li id='item'><img src='images/insurance/"+tv.getImage()+"' alt='' /></li>");
