...
public class Doctor extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(CategoryName==null){
			hm = MySqlDataStoreUtilities.getDoctors();
			name = "";
		}
		else
		{

			for(Map.Entry<String,Com> entry : MySqlDataStoreUtilities.getDoctors().entrySet())
			{
		...
		All the TV and TV information are dispalyed in the Content ection
		...
		pw.print("<a style='font-size: 24px;'>"+(CategoryName==null ? "":CategoryName)+" Doctors</a>");
		...
		for(Map.Entry<String, Com> entry : hm.entrySet())
		{
			...
			pw.print("<li id='item'><img src='images/Doctor/"+tv.getImage()+"' alt='' /></li>");
