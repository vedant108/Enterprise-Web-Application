...
public class DealMatches extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<a href='#'> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Welcome to Yours Health Hub </a></h2>");
		
		pw.print("<div class='entry'>");
		pw.print("<img src='images/site/cover.png'style='width: 600px; display: block; margin-left: auto; margin-right: auto' />");
		pw.print("<br> <br>");
		pw.print("<h2>One Stop Solution for All Your Health Care Needs</h2>");
		pw.print("<br> <br>");
...
//			
			...
			catch(Exception e)
			{
				...
				// System.out.println("Hwre is  error" + e);
			pw.print("<h2 align='center'>No Offers Found</h2>");
			}
		pw.print("</div>");
		pw.print("</div>");
