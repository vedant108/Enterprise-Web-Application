...
public class CheckOut extends HttpServlet {
	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<input type='hidden' name='appointmentdate' value='"+request.getParameter("appointmentdate").toString()+"'>");
		pw.print("</td></tr></table><table><tr></tr><tr></tr>");	
		
		pw.print("<br>");
		pw.print("<h3>Personal Information :</h3>");
		...
		pw.print("<tr><td>");
     	pw.print("Street Name:</td>");
		pw.print("<td><input type='text' name='userAddress1'>");
		pw.print("</td></tr>");
		
		pw.print("<tr><td>");
     	pw.print("City: </td>");
		pw.print("<td><input type='text' name='userAddress2'>");
		pw.print("</td></tr>");
		
		pw.print("<tr><td>");
     	pw.print("State: </td>");
		pw.print("<td><input type='text' name='userAddress3'>");
		pw.print("</td></tr>");
		
		pw.print("<tr><td>");
     	pw.print("Zip Code: </td>");
		pw.print("<td><input type='text' name='userAddress4'>");
		pw.print("</td></tr>");
		
		pw.print("<tr><td>");
     	pw.print("Country: </td>");
		pw.print("<td><input type='text' name='userAddress5'>");
		pw.print("</td></tr>");
