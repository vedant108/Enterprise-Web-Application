...
public class Healthclub extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(CategoryName==null){
			hm = MySqlDataStoreUtilities.getClubs();
			name = "";
		}
		else
		{

			for(Map.Entry<String,Com> entry : MySqlDataStoreUtilities.getClubs().entrySet())
			{
		...
		pw.print("<a style='font-size: 24px;'>"+(CategoryName==null ? "":CategoryName)+" Health Club</a>");
		...
		{	
			...
			pw.print("<li id='item'><img src='images/Healthclub/"+tv.getImage()+"' alt='' /></li>");
