...
public class AjaxUtility {
	...
	public static void storeData(HashMap<String,Product> productdata)
	{
		try
		{
			...
			String insertIntoProductQuery = "INSERT INTO product(productId,productName,image,retailer,productCondition,productPrice,productType) "
			+ "VALUES (?,?,?,?,?,?);";	
			...
			{	
				...
				pst.setDouble(5,entry.getValue().getPrice());
				pst.setString(6,entry.getValue().getType());
				pst.execute();
			}
		}
		catch(Exception e)
