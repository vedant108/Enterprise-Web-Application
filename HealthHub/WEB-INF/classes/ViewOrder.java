...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<a style='font-size: 24px;'>Activity</a>");
		...
		if(request.getParameter("Order")!=null && request.getParameter("Order").equals("ViewOrder"))
		{
			...
			if (request.getParameter("orderId") != null && !request.getParameter("orderId").isEmpty() )
			{
				...
				{	
					...
					pw.print("<td>ServiceOrdered:</td>");
					pw.print("<td>ServiceCharges:</td>");
					pw.print("<td></td></tr>");
				...
				for (OrderPayment oi : orderPayments.get(orderId)) 
					{
							...
							{
								Period diff = Period.between(today,oi.getAppointmentDate());
								...
								if(days>=5){
									...
									pw.print("<h4 style='color:red'>Can't cancel order. Delivery date is before 5 days.</h4>");	
								}							
							}
					}
