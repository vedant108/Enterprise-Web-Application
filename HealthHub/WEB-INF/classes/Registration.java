...
public class Registration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else
			{
				...
				MySqlDataStoreUtilities.insertUser(username,password,repassword,usertype,name,address1+" "+address2+" "+city+" "+state+" "+country,pincode);					
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>Address1: </h3></td><td><input type='text' name='address1' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
				+ "<h3>Address2: </h3></td><td><input type='text' name='address2' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
				+ "<h3>Pincode: </h3></td><td><input type='text' name='pincode' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>Country: </h3></td><td><input type='text' name='country' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
				+ "<h3>User Type</h3></td><td><select name='usertype' class='input'><option value='customer' selected>Customer</option><option value='manager'>Admin</option><option value='retailer'>Salesman</option></select>"
				+ "</td></tr></table>"
