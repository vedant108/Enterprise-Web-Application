...
public class ProductRecommenderUtility{
	...
	public static Product getProduct(String product){
		...
		try 
		{
			...
			while(rs.next())
			{	
				prodObj = new Product(rs.getString("Id"),rs.getString("productName"),rs.getDouble("productPrice"),rs.getString("productImage"),rs.getString("productCategory"),rs.getString("ProductType"));
			}
			rs.close();
			pst.close();
			conn.close();
